...
//$url = 'https://intcomex-test.apigee.net/v1/getproduct?ku=AC004HUA65';
...
$headers = array(
   ...
   //"Authorization: Bearer apiKey=".$apikey."&utcTimeStamp=".$time."&signature=".hash('sha256',$apikey.','.$accesKey.','.date('Y-m-d\TH:i:s\Z')),
